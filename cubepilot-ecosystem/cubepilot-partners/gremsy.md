...
| <p><strong>Specifications for</strong><br><strong>MIO</strong></p> |                                                                                                 |
| ------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------- |
| **Dimensions (D x W x H)**                                         | <p>120 x 99 x 175 mm (gimbal) <br>43 x 85 x 70 mm (camera cage)</p>                             |
| **Weight**                                                         | 0.55 lbs (250 g)                                                                                |
| **Maximum Payload**                                                | 0.88 lbs (400g)                                                                                 |
| **Connection**                                                     | USB 2.0, DJI A3 CAN, UART, S-bus, PPM, Bluetooth, Micro HDMI                                    |
| **Gimbal Mode**                                                    | Lock Mode, Follow Mode, Mapping Mode, Inverted Mode, Front Mode                                 |
| **Control Mode**                                                   | SBUS/PPM/LB2//MAVLink                                                                           |
| **Controlled Rotation Range**                                      | <p>Pan axis control: ±325° </p><p>Tilt axis control: ± 120° </p><p>Roll axis control: ± 40°</p> |
...
| **Controlled Rotation Range**                                          | <p>Pan axis control: +330° to -330° </p><p>Tilt axis control: +135° to -45° </p><p>Roll axis control: ± 45°</p> |
...
| **Gimbal Mode**                      | Lock Mode, Follow Mode, Mapping Mode, Inverted Mode                                                       |
| **Control Mode**                     | SBUS / Spektrum / PPM / LB2 / MAVlink                                                                     |
| **Controlled Rotation Range**        | <p>Pan axis control: +330° to -330° <br>Tilt axis control: +135° to -45° <br>Roll axis control: ± 45°</p> |
...
| ------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| **Dimensions (D x W x H)**            | 170 x 157 x 180 mm (gimbal)                                                                                     |
| **Weight**                            | 1.0 lbs (470 g)                                                                                                 |
| **Payload**                           | Wiris Security                                                                                                  |
| **Connection**                        | USB 2.0, DJI A3 CAN, UART, S-bus, Spektrum, PPM, Bluetooth, Micro HDMI                                          |
| **Gimbal Mode**                       | Lock Mode, Follow Mode, Mapping Mode, Inverted Mode                                                             |
| **Control Mode**                      | SBUS / Spektrum / PPM / LB2 / MAVlink                                                                           |
| **Controlled Rotation Range**         | <p>Pan axis control: +330° to -330° </p><p>Tilt axis control: +135° to -45° </p><p>Roll axis control: ± 45°</p> |
...
| <p>Specifications for <br>GREMSY T3</p> |                                                                                                  |
| --------------------------------------- | ------------------------------------------------------------------------------------------------ |
| **Dimensions (D x W x H)**              | <p>184 x 237 x 288 mm (gimbal) <br>100 x 152 x 120 mm (camera cage)</p>                          |
| **Weight**                              | 2.65 lbs (1200 g)                                                                                |
| **Maximum Payload**                     | 3.7 lbs (1700g)                                                                                  |
| **Connection**                          | USB 2.0, DJI A3 CAN, UART, S-bus, Spektrum, PPM, Bluetooth, Micro HDMI                           |
| **Gimbal Mode**                         | Lock Mode, Follow Mode, Mapping Mode, Inverted Mode                                              |
| **Control Mode**                        | SBUS / Spektrum / PPM / LB2 / MAVlink                                                            |
| **Controlled Rotation Range**           | <p>Pan axis control: ± 330° </p><p>Tilt axis control: ± 120° </p><p>Roll axis control: ± 45°</p> |
...
| <p>Specifications for <br>GREMSY S1</p> |                                                                                                  |
| --------------------------------------- | ------------------------------------------------------------------------------------------------ |
| **Dimensions (D x W x H)**              | <p>168 x 150 x 220 mm (gimbal) <br>65 x 120 x 75 mm (camera cage)</p>                            |
| **Weight**                              | 1.8 lbs (830 g)                                                                                  |
| **Maximum Payload**                     | 1.6 lbs (750g)                                                                                   |
| **Connection**                          | USB 2.0, DJI A3 CAN, UART, S-bus, Spektrum, PPM, Bluetooth, Micro HDMI                           |
| **Gimbal Mode**                         | Lock Mode, Follow Mode, Mapping Mode, Inverted Mode                                              |
| **Control Mode**                        | SBUS / Spektrum / PPM / LB2 / MAVlink                                                            |
| **Controlled Rotation Range**           | <p>Pan axis control: ± 330° </p><p>Tilt axis control: ± 120° </p><p>Roll axis control: ± 45°</p> |
